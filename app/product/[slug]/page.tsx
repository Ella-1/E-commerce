...
import { ImageGalary } from "@/app/imageGalary"
       ...
       <div className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 md:px-8">
                <div className="grid gap-8 md:grid-cols-2">
                    <ImageGalary  images={data.images} /> 
                    ...
                    <div className="md:py-8">
                        ...
                        <div className="mb-6 flex items-center gap-3 md:mb-10 ">
                           ...
                           <span className="text-sm text-gray-500 transition duration-100">58 rating</span>
                        </div>
                        ...
                        <div className="flex gap-2.5">
                            <AddToBag currency="USD" description={data.description} image={data.images} name={data.name} price={data.price} _id={""} sku={""}/>
